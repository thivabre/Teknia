...
try {
    ...
    if ($accion == 'update_precio') {
        ...
        $id_inv_repuestos_new = $_POST['id_inv_repuestos_new'];
        $id_repuesto_new = $_POST['id_repuesto_new'];
    ...
    } elseif ($accion == 'update_intermedia_rep_pres') {
        $id_presupuesto_old = $_POST['id_presupuesto_old'];
        $id_repuesto_old = $_POST['id_repuesto_old'];
        $id_presupuesto_new = $_POST['id_presupuesto_new'];
        $id_repuesto_new = $_POST['id_repuesto_new'];
        $BD->begin_transaction();
