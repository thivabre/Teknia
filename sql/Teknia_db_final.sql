...
create table localidad(
    id_localidad int(11) not null auto_increment primary key,
...
create table sueldo(
    id_sueldo int(11) not null auto_increment primary key,
...
create table impuestos(
    id_impuestos int(11) not null auto_increment primary key,
...
create table articulo_reparar(
    id_articulo_reparar int(11) not null auto_increment primary key,
...
create table garantia_servicio(
    id_garantia_servicio int(11) not null auto_increment primary key,
...
create table inventario_repuestos(
    id_inv_repuestos int(11) not null auto_increment primary key,
    cantidad_rep int(11) not null
);

create table presupuestos(
    id_presupuesto int(11) not null auto_increment primary key,
    precio_reparacion_tot int(11) not null
);

create table inventario_productos(
    id_inv_productos int(11) not null auto_increment primary key,
    cantidad_prod int(11) not null
);

create table direccion_empleado(
    id_dire_empleado int(11) not null auto_increment primary key,
    calle_emp varchar(30) not null,
    altura_emp int(4) not null,
    cod_postal_emp int(4) not null,
    id_localidad int(11) not null unique,
    foreign key (id_localidad) references localidad(id_localidad)
);

create table direccion_cliente(
    id_dire_cliente int(11) not null auto_increment primary key,
...
create table direccion_sucursal(
    id_dire_sucursal int(11) not null auto_increment primary key,
...
create table direccion_proveedor(
    id_dire_proveedor int(11) not null auto_increment primary key,
...
create table contrato_empleado(
    id_contrato_emple int(11) not null auto_increment primary key,
    fecha_cont date not null,
    turno varchar(15) not null,
    id_sueldo int(11) not null unique,
...
create table repuestos(
    ...
    id_precio int(11) not null unique,
    foreign key (id_precio) references precio(id_precio)
);

create table factura_servicio(
    id_factura_servicio int(11) not null auto_increment primary key,
    fecha_factura date not null,
    id_pago int(11) default null unique,
    id_garantia_servicio int(11) not null,
    id_presupuesto int(11) not null unique,
...
create table proveedor(
    ...
    id_repuesto int(11) not null unique,
...
create table intermedia_inv_rep(
    ...
    primary key (id_inv_repuestos, id_repuesto),
...
create table sucursales(
    ...
    id_inv_repuestos int(11) not null unique,
    id_inv_productos int(11) not null unique,
...
create table empleado(
    ...
    id_contrato_emple int(11) not null unique,
...
create table orden_servicio(
    id_orden_servicio int(11) not null auto_increment primary key,
    fecha_orden date not null,
    fecha_est_fin date not null,
    id_sucursal int(11) not null,
    id_articulo_reparar int(11) not null unique,
    id_presupuesto int(11) not null unique,
...
create table orden_entrega(
    id_orden_entrega int(11) not null auto_increment primary key,
    fecha_entrega date not null,
    id_orden_servicio int(11) not null unique,
    id_factura_servicio int(11) not null unique,
